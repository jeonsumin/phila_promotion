import {PLACE} from "shared/constant/place";
...
export const RECOMMEND_RESULT = [
    {
        ...
        recommend: PLACE.filter(place => ["home_main_space_014", 'home_main_space_012', 'reco_detail_type1_result1_alt_004'].includes(place.title))
    },
    {
        type: 'B',
        ...
        recommend: PLACE.filter(place => ["home_main_space_012","home_main_space_013","reco_detail_type3_result1_alt_002"].includes(place.title))
    },
    {
        type: 'C',
        ...
        recommend: PLACE.filter(place => ["home_main_space_016","home_main_space_017","reco_detail_type3_result1_alt_002"].includes(place.title))
    },
    {
        type: 'D',
        ...
        recommend: PLACE.filter(place => ["reco_detail_type4_result1_004","reco_detail_type4_result1_alt_002","home_main_space_015"].includes(place.title))
    },
]
